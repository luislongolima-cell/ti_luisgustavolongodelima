...
//Adicionei o quarto cartão no HTML usando a classe ".apoiar" no botão para o JS reconhecê-lo.
...
//Mudaria a variável dele para `let apoiado = true;`. Não serve para os outros porque os demais começam desapoiados (`false`).